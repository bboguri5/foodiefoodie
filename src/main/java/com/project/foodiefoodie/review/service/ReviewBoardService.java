...
public class ReviewBoardService {
    ...
    private static final String REVIEW_UPLOAD_PATH = "/home/ec2-user/foodiefoodie/reviewBoard";
//    private static final String REVIEW_UPLOAD_PATH = "C:\\foodiefoodie\\reviewBoard";
...
//                log.info("fileData - {}", fileData);
    ...
    private String getReviewNewUploadPath(long reviewBno) {
        ...
        String newUploadPath = REVIEW_UPLOAD_PATH;
...
//              리뷰, 이미지 저장이 잘 되었으면 가게 평점 & 리뷰 개수 업데이트 해주기
    ...
    public void deleteFile(Long reviewBno) {
        ...
        String path = REVIEW_UPLOAD_PATH + File.separator + reviewBno;
    ...
    public boolean modifyReviewFile(List<MultipartFile> reviewImg, ReviewBoard reviewBoard, long reviewBno) {
        ...
        if (flag) {
            String originReviewImgPath = REVIEW_UPLOAD_PATH +File.separator + reviewBno;
