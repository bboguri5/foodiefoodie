...
<head>
    ...
    <link href="/mypage/css/date_picker.css" rel="stylesheet">
    <!-- Your custom styles -->
    <link href="/mypage/css/custom.css" rel="stylesheet">
    <!-- WYSIWYG Editor -->
    <link rel="stylesheet" href="/mypage/js/editor/summernote-bs4.css">
</head>
...
<body class="fixed-nav sticky-footer" id="page-top">
    ...
    <script src="/mypage/vendor/bootstrap-datepicker.js"></script>
    <script>
    $('input.date-pick').datepicker();
    </script>
    <!-- WYSIWYG Editor -->
    <script src="/mypage/js/editor/summernote-bs4.min.js"></script>
    <script>
    $('.editor').summernote({
        fontSizes: ['10', '14'],
        toolbar: [
